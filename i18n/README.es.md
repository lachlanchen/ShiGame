...
La validación comprueba grafo, referencias, claves lingüísticas, reglas, tipos y pruebas. La prueba visible noVNC/Chrome superó 50 controles de juego, respuestas de presión, teclado, fuentes, guardado, RTL, móvil, WebGL y consola. Véase la [evidencia](../docs/production/PLAYTESTING.md).

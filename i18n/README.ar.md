...
| [`docs`](../docs/) | تصميم وتاريخ وهندسة وتعريب وفن واختبار ونشر وخارطة طريق مرحلية للجودة |
...
ملف JSON ذي الإصدار هو مصدر السرد الوحيد، وتتشاركه قواعد TypeScript الحتمية وUnity 6. الكتب الخاصة وOCR والمحادثات والمذكرة الكاملة لا تدخل Git. راجع [تصميم اللعبة](../docs/design/GAME_DESIGN_DOCUMENT.md) و[سياسة المصادر](../docs/history/SOURCE_POLICY.md) و[خارطة طريق الجودة المرحلية](../docs/production/ROADMAP.md).

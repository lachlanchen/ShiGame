...
يفحص التحقق الآلي شبكة الحملة والمراجع ومفاتيح اللغات والقواعد والأنواع والاختبارات. واجتاز اختبار noVNC/Chrome المرئي 31 فحصًا للعب واستجابة الضغط ولوحة المفاتيح والمصادر والحفظ وRTL والهاتف وWebGL ووحدة التحكم. [الدليل هنا](../docs/production/PLAYTESTING.md).

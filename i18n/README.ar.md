...
| [`apps/unity`](../apps/unity/) | Unity 6 وطاولة عمليات ثلاثية الأبعاد؛ استيراد المحرر وبناؤه بوابة محجوبة ومعلنة |
...
يفحص التحقق الآلي شبكة الحملة والمراجع ومفاتيح اللغات والقواعد والأنواع والاختبارات. واجتاز اختبار noVNC/Chrome المرئي 21 فحصًا للعب والمصادر والحفظ وRTL والهاتف وWebGL ووحدة التحكم. [الدليل هنا](../docs/production/PLAYTESTING.md).
...
نسخة ما قبل ألفا بتاريخ 2026-08-08. بُني فصل الويب واختُبر بصريًا. مشروع Unity حقيقي لكنه لم يُجمع بعد بسبب مشكلة نقطة تنزيل محرر Linux الرسمية؛ لا نخفي هذه البوابة الحمراء. لن يُعلن الاكتمال قبل اجتياز العميلين والبحث واللغات والأصول واختبارات اللعب والإصدار.

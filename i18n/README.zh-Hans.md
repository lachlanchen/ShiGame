...
| [`apps/unity`](../apps/unity/) | 读取同一战役的 Unity 6 工程与 3D 军议图；编辑器导入/构建仍是公开阻塞项 |
...
2026-08-08 前期版本。网页章节已构建并通过可见测试；Unity 工程内容真实存在，但因官方 Linux 编辑器下载端点问题尚未完成编译，因此明确保持红灯。项目将在一年内按质量关卡继续，不会在双端构建、史料、本地化、资产、试玩与发布检查真正通过前宣称完成。

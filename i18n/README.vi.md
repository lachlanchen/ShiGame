...
Xác nhận tự động kiểm tra đồ thị, tham chiếu, khóa ngôn ngữ, luật, kiểu và test. Bài test noVNC/Chrome hiển thị đã qua 21 mục về chơi, nguồn, lưu, RTL, di động, WebGL và console. Xem [bằng chứng](../docs/production/PLAYTESTING.md).

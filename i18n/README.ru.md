...
| [`apps/unity`](../apps/unity/) | Unity 6 и 3D-стол; импорт/сборка редактора остаётся открытым блокером |
...
Пре-альфа от 2026-08-08. Веб-глава собрана и проверена визуально. Unity пока не скомпилирован из-за официальной точки загрузки Linux; этот красный этап не скрывается. Проект не будет назван завершённым до проверки обоих клиентов, исследований, языков, ресурсов, плейтестов и релиза.

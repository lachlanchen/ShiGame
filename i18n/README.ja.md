...
| [`apps/unity`](../apps/unity/) | Unity 6 と3D軍議卓。エディタ導入・ビルドは未通過の公開ゲート |
...
2026-08-08 プレアルファ。Web章はビルド・可視試験済みです。Unityは公式Linuxエディタ取得問題のため未コンパイルで、赤いゲートを隠していません。両クライアント、史料、多言語、資産、プレイテスト、公開基準を満たすまで完成とはしません。

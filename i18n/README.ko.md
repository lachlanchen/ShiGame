...
| [`apps/unity`](../apps/unity/) | Unity 6과 3D 작전 탁자. 에디터 가져오기/빌드는 아직 공개된 차단 항목 |
...
캠페인 그래프, 인용, 번역 키, 규칙, 타입, 테스트를 자동 검증합니다. 보이는 noVNC/Chrome 시험은 플레이, 출처 분류, 저장, RTL, 모바일, WebGL, 콘솔 21개 항목을 통과했습니다. [시험 증거](../docs/production/PLAYTESTING.md)를 확인할 수 있습니다.
...
2026-08-08 프리알파. 웹 장은 빌드와 가시 시험을 통과했습니다. Unity는 공식 Linux 에디터 다운로드 문제로 아직 컴파일되지 않았고 이 빨간 게이트를 숨기지 않습니다. 두 클라이언트, 사료, 현지화, 자산, 플레이테스트, 출시 기준이 통과되기 전에는 완료라 부르지 않습니다.

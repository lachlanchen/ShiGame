...
2026-08-08 前期版本。網頁章節已構建並通過可見測試；真正的 Linux/WebGL Unity 編輯器已安裝並由 Hub 識別。原生導入與編譯仍需帳戶持有人登入並啟用 Unity 授權；Unity 6 生產版本鎖定不變。雙端構建、史料、本地化、資產、試玩與發布關卡真正通過前，專案不會宣稱完成。

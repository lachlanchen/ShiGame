...
| [`apps/unity`](../apps/unity/) | Unity 6 與 3D 軍議圖；編輯器導入/構建仍是公開阻塞項 |
...
自動驗證涵蓋戰役圖、引用、翻譯鍵、規則、型別與測試；可見 noVNC/Chrome 另通過 21 項玩法、RTL、行動版與存檔檢查。證據見[測試說明](../docs/production/PLAYTESTING.md)。
...
2026-08-08 前期版本。網頁章節已構建並通過可見測試；Unity 專案尚因官方 Linux 編輯器端點問題未完成編譯。雙端構建、史料、本地化、資產、試玩與發布關卡真正通過前，專案不會宣稱完成。

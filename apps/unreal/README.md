...
- pointer world-piece picking, `Tab`/Gamepad RB site cycling, `C`/Gamepad L3 signal cycling, Shift reverse cycling, `Home` return to current ground and `Space` camera/response-beat skip;

...
Unreal reprioritization status on 2026-08-10: Epic's official UE `5.8.1` installed build (changelist `56057345`) generates the project, compiles/links `SHIEditor` and passes exactly fifteen native `SHI.` suites. Those suites execute all 46 campaign routes plus the 76-route Broken Crossing exercise and its save, transaction, source/claim, audio, wartable, spatial-signal, council, command-weight, command-surface, wet-field, shelter and consequence contracts against campaign hash `a82ab2f28809`. The official Linux development route passes compile/cook/stage/archive; the latest environment package has 509 packages, exactly four beyond the wet-field baseline. The deterministic command weight, fictional earth/wood command ground, `24 × 24 m` wet field and fictional practical Daze shelter each have source/interchange, exact Unreal import/material, package/smoke and visible-play receipts; rejected neural, polished-gold, pale-plaster, pale-field, over-dark, checker-color, roof-penetration and LOD-silhouette passes remain explicit. The normal player visibly advances Act I → Act III, completes Broken Crossing beneath the shelter, returns the campaign unchanged and can separately seal/cold-replay the four-decision chapter. A physical 60 Hz FPS chart records 195.18 FPS average on the prior accepted scene and zero hitches; final-scene timing must be repeated. Packaged persistence/world-preflight failures, cuts-only consequence/skip/restart and direct native audio capture pass. Editor PIE remains red after an NVIDIA Vulkan outdated-swapchain crash; rain/vegetation, period figures/formations, physical controller, final-scene performance, natural-motion/human-audio review and observed-player evidence remain open.

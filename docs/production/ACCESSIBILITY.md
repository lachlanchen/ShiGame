...
- Unreal exposes a separately persisted **Reduced motion · cuts only** mode through Slate, `V` and Gamepad Menu. It converts site inspection, signal inspection and consequence travel to immediate cuts while preserving every consequence beat's reading time and semantic lens; it neither mutates the chronicle nor wakes an armed audio preference. Official native automation passes the motion grammar; OS-preference integration, visible comfort and persistence review remain open.
...
| Unreal motion | official native automation passes deterministic first/far cuts, eased travel only within 100 Unreal units/6°, fixed 40°–58° lenses and command isolation; visible comfort/persistence remain open |

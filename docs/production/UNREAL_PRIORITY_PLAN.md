...
1. Rain-soaked Daze command space with an explorable wartable/assembly composition. Canonical speaker/Keeper blocking, a 44° dialogue lens, five identity-Root shared-skeleton production blockouts, two role-bound body-performance loops and an exact 21-control silent facial-intent lane on all five meshes now pass their bounded packaged visual proof. The shared face remains a generic non-portrait engineering blockout; interaction hands, mouth interior, voice/lip sync, close framing, visible fallback, final clothing/art/acting and human historical/cultural/accessibility review remain open.
2. Inspectable route/intelligence ground and command state are source-authored as five bounded canonical 3D sites plus nine live grain/trust/momentum/people/exposure/field/pursuit/method/oath signals with pointer/keyboard/gamepad focus, non-color-only shape/height/text grammar and scoped evidence. Native packaged interaction and review pass at the current blockout boundary; physical-controller and human accessibility review remain open.
...
5. In-world and UI feedback for resource/commitment/enemy/field state is source-authored. Order resolution, refreshed signals, consequence authorship, live-actor closure and the candidate save cross one fail-closed, durable-first transaction before active gameplay advances. Native packaged execution plus unwritable-save/restart and missing-actor failure injection pass; broader security and human-observed recovery review remain open.
6. Act, scene, site and date advance from the register into organization.
7. A 3.52–4.08-second six-or-seven-beat camera sentence with a five-second hard ceiling, one highlighted world target, exact Slate readout, first/far cuts, eased travel only within 100 Unreal units/6°, fixed 40°–58° semantic lenses, complete command isolation, persisted cuts-only reduced motion and whole-sequence completion/skip into the next canonical speaker. Native packaged completion, skip, handoff and cuts-only persistence pass; final-scene lens/motion comfort and human accessibility review remain open.
8. Opt-in rain and semantic order/consequence sound with independent persistent controls and no exclusive information.
9. Save/reload and source/evidence access. Native packaged interaction, replay, tamper rejection and evidence access pass at the current blockout boundary; observed-player and final accessibility review remain open.
10. Linux Development and packaged builds, automation tests and visible noVNC play evidence.

Current 2026-08-10 checkpoint: the official UE 5.8.1 client compiles and passes exactly 20 native `SHI.` suites. Facial v2 cooks and mounts 559 packages, adding exactly 21 isolated assets—five morph-bearing meshes, fifteen materials and one CC0 eye texture—over the accepted 538-package body-performance baseline. All five meshes retain the exact deterministic 21-control silent facial-intent contract. Packaged v1 was rejected because `SkinClay` and `EyeBrown` lacked `MorphTargets` material usage and fell back to **Default Material**; corrected v2 saves all fifteen materials for `SkeletalMesh` and exactly those two for `MorphTargets`. Visible development review accepts Chen Sheng as normal and reduced-motion speaker plus the Keeper as normal listener. Facial v2 did not rerun story progression or a separate headless smoke; prior v5 remains the latest proof of real keyboard Act I → Act II progression with verified autosave and clean 538-package Entry/`ShiGameMode` smoke. The generic shared face is not final art or historical evidence. Interaction hands, mouth interior, voice/lip sync, close framing, visibly exercised fallback, reviewed formations/lighting, final art/acting and human historical/cultural/accessibility review remain open before “film quality.” See the [facial presentation evidence](evidence/unreal-daze-council-facial-performance-presentation-status.json).

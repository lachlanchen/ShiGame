...
Current 2026-08-10 checkpoint: the official UE 5.8.1 client compiles, passes 16 native suites, packages and visibly plays. The command weight, fictional earth/wood command ground, `24 × 24 m` wet field, open Daze field shelter and deterministic rain are admitted production blockouts with exact source/import/material/package hashes. The 513-package player advances two fresh campaign transactions, completes the three-pulse Broken Crossing exercise in rain beneath the dry shelter and returns the byte-identical campaign save unchanged. This clears engine/playability, default-white-surface, empty-sky shelter and first motivated-weather defects only; vegetation, historically reviewed figures/formations, final sky/lighting/weather response, final-scene performance/accessibility and human review remain open before “film quality.”

...
- Pressure warnings, disclosed reconstruction-classified pursuit/field signals, four-stage choice feedback, source drawer and persistent decision record: pass.
...
- Fixed-seed contract: pass for pre-choice condition/effects, post-choice pursuit/field deltas, save-v4 seed persistence, posture identity, and decision-record retention.

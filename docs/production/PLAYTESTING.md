...
- Pressure warnings, disclosed reconstruction-classified pursuit/method-read/field signals, five-layer choice feedback, source drawer and persistent decision record: pass.
...
- Fixed-seed/read contract: pass for pre-choice condition/effects, post-choice pursuit/method/field deltas, save-v5 seed persistence, posture/method/read identity, and decision-record retention.

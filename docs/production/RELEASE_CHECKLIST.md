...
Five authored Unreal blocks now close a bounded runtime subset. `shi-command-weight-v1`, `shi-command-surface-v1`, `shi-wet-field-environment-v1`, `shi-daze-field-shelter-v1` and `shi-daze-rain-vfx-v1` pass deterministic source/interchange validation, explicit LOD/UV/material/collision contracts, UE 5.8.1 admission, compile-clean blockout graphs, forced cook, clean archived-player launch and visible story/engagement use. The rain package cooks 513 packages—exactly the accepted 509 shelter baseline plus two meshes and two materials—and visibly completes Broken Crossing before returning the byte-identical canonical campaign save. The project-wide 3D box stays open because vegetation, formations, period-reviewed characters/interaction hands, final materials/sky/lighting/weather response, physical final-scene performance/accessibility and human art/cinematic/historical review remain incomplete. See [`unreal-daze-rain-presentation-status.json`](evidence/unreal-daze-rain-presentation-status.json) and [`unreal-daze-rain-import-status.json`](evidence/unreal-daze-rain-import-status.json).

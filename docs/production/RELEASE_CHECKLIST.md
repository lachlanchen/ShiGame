...
The first authored Unreal prop closes a narrower runtime-blockout subset. `shi-command-weight-v1` passes deterministic source/interchange validation, closed outward topology, LOD0/LOD1 reduction, UV0/lightmap UV1, exact material slots, centimeter scale, named convex collision, UE 5.8.1 import, compile-clean authored blockout PBR graphs, exact surface contact/clearance/44° placement, development-only front/back inspection, forced cook, exact IoStore content inspection, clean archived-player launch and visible Act-II story progression. The project-wide 3D box stays open because the white BasicShape command surface, terrain, formations, characters/interaction hands, final material treatment, physical final-scene performance and human art/cinematic review remain incomplete. See [`unreal-command-weight-presentation-status.json`](evidence/unreal-command-weight-presentation-status.json) and the immutable [`unreal-command-weight-import-status.json`](evidence/unreal-command-weight-import-status.json).

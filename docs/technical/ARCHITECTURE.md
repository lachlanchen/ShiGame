...
- Static repository validation is green. Unreal automation source covers bounded wartable projection/camera/status/cycling/overlap rejection; exact live-signal values/order/anchoring/camera/cycling, active-oath and captured-terminal states, post-order refresh, cross-family spacing and atomic failure; consequence order/timing/world closure/non-mutation/terminal failure/atomic rejection, deterministic cut/ease authorship and semantic lens identity after every turn of all 46 golden routes; source/claim/rights closure and hostile URL drift; every intermediate gameplay layer; save round-trip/tamper rejection; and procedural-audio contracts. Native target compilation, automation execution, PIE site/signal/evidence/consequence motion/lens/reduced-motion interaction, audio-device capture/listening, asset import, Linux packaging and human cinematic/playability review remain red until an official Epic installed build is available.

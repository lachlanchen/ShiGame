...
- The corrected exact-implementation recording passes all eight browser checks at −35.7 LUFS, −22.7 dBTP and −22.69 dBFS with negligible DC, exact channel parity and zero console errors. Screenshot and spectrogram inspection confirm that the startup broadband burst is gone.

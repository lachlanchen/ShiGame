...
| [`apps/unreal`](apps/unreal/) | Priority Unreal Engine 5.8 C++ cinematic client: canonical schema-v7/audio/edition/character loaders, fail-closed source/claim/rights and speaker validation, presentation-independent deterministic session, 46-route golden replay suite, durable-first order/restart transactions, six-layer all-scene progression, bounded five-site wartable plus nine live resource/field/pursuit/method/oath 3D signals, deterministic speaker/Keeper blocking with explicit historical/reconstruction disclosure and clickable multi-part performance proxies, scoped historical basis, and a six-or-seven-beat consequence grammar that binds exact resolved layers to live actors before handing control to the next canonical council speaker; opt-in procedural rain/cues, persisted mix controls and the official Linux build wrapper are source-authored, while native compile/play/audio evidence remains open until the official installed build is obtained |
...
Pre-alpha schema-v7/Unreal-priority checkpoint, 2026-08-09. Shared broken-crossing source implementation `c4c7c1150ec287ba4f3335de2c8e7d966ba79bf6` adds a strict engagement payload and pure replay-verified command resolver; the complete production build passes 53 TypeScript/UI tests, all 76 engagement routes, 689 successful and 87 capture/scattering campaign condition routes, the 46-route cross-engine corpus, static Unreal/history/audio/accessibility/font/privacy gates and all bundle budgets. The engagement is deliberately **not yet campaign-authoritative** until Web and native Unreal replay it identically. The native baseline at canonical council-staging implementation `5764a2dc7071ea2355214ae1aec6f9922e1a2a65` loads the shared character register and per-node speaker, rejects unknown/duplicate cast or missing dialogue, derives an exact speaker/Keeper stage with a 44° dialogue camera, labels historical words as authored dramatization and fictional speakers as reconstruction, and drives two persistent clickable body/head/mantle performance proxies. `D`, Gamepad R3, Slate or a figure click restores the non-mutating council shot; every consequence completes or skips into the next canonical speaker. The next stage crosses the same copied-session, independent-replay, live-actor and durable-first order/restart transaction as the save, rule record, selection, nine signals and consequence cinema. Cast, dialogue, disclosure, blocking, lens, world, cinema, actor or save drift holds the order and preserves the current chronicle; all 46 golden routes require the staged council node to equal the authoritative post-order position. Exact documented boundary `3684bf22dc72770ff4f1f4ad38748ad8a4ceba76` passes a detached clean install/build plus hosted validation `31303607722` and Pages deployment `31303607727`; local, tracking and remote Git identities matched, and the deployed Web game plus localhost Unreal noVNC entry returned HTTP 200 before this evidence-note commit. The last complete visible-browser campaign run remains pinned to `a11e173a58d9290f1368f1596e730a13ccb5e820` with 248 checks across all acts/scenes, desktop/mobile, eleven locales, forced colors, 320px reflow and actual Chrome 400% zoom. The initial player remains inside the caps at 99.47 KiB JavaScript, 11.94 KiB CSS, 178.95 KiB largest lazy JavaScript, 22.94 MiB fonts and 26.84 MiB deployable output. The official 5.8.1 archive is currently being acquired through an outside-Git private supervisor, but Unreal is **not yet claimed native-playable, final-character quality or film quality**: native compile/automation, PIE figure/collision/failure injection, interaction/handoff/motion/lens/reduced-motion review, final reviewed character import, Linux packaging, performance and human review remain red. Unity remains a maintained baseline with its existing license gate. Human listening, assistive-technology, physical-controller, observed-player, Qin-law, geography and translation review also remain open. SHI is a one-year quality-driven production; no source-only engine boundary is allowed to masquerade as a shipped game.
